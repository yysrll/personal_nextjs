...
export default function TopNav() {
  ...
  return (
    <nav className="fixed top-0 flex h-16 w-full items-center justify-between bg-gray-500/10 px-12 backdrop-blur-lg md:px-32 lg:h-20 lg:px-48 dark:bg-white/10">
